...
media.push(
  ...
  {
    id: "user-nwh-tobey",
    src: "media/user-nwh-tobey.jpg",
    universe: "tobey",
    work: "Homem-Aranha: Sem Volta Para Casa",
    year: "2021",
    description: "Tobey Maguire como Peter Parker durante o confronto final.",
    source: "Arquivo fornecido pelo usuário",
    sourceUrl: "https://www.sonypictures.com/movies/spidermannowayhome",
    credit: "Imagem fornecida pelo usuário",
    nature: "imagem de referência",
    usage: "Seleção visual indicada pelo usuário para o perfil de Tobey Maguire.",
    alt: "Tobey Maguire usando o traje do Homem-Aranha em Sem Volta Para Casa.",
    focus: "50% 32%",
  },
  {
    id: "user-nwh-andrew",
    src: "media/user-nwh-andrew.jpg",
    universe: "andrew",
    work: "Homem-Aranha: Sem Volta Para Casa",
    year: "2021",
    description: "Andrew Garfield como Peter Parker usando seu traje.",
    source: "Arquivo fornecido pelo usuário",
    sourceUrl: "https://www.sonypictures.com/movies/spidermannowayhome",
    credit: "Imagem fornecida pelo usuário",
    nature: "imagem de referência",
    usage: "Seleção visual indicada pelo usuário para o perfil de Andrew Garfield.",
    alt: "Andrew Garfield usando o traje do Homem-Aranha em Sem Volta Para Casa.",
    focus: "50% 28%",
  },
  {
    id: "user-nwh-tom",
    src: "media/user-nwh-tom.jpg",
    universe: "tom",
    work: "Homem-Aranha: Sem Volta Para Casa",
    year: "2021",
    description: "Tom Holland como Peter Parker após o confronto final.",
    source: "Arquivo fornecido pelo usuário",
    sourceUrl: "https://www.sonypictures.com/movies/spidermannowayhome",
    credit: "Imagem fornecida pelo usuário",
    nature: "imagem de referência",
    usage: "Seleção visual indicada pelo usuário para o perfil de Tom Holland.",
    alt: "Tom Holland como Peter Parker ferido usando o traje do Homem-Aranha em Sem Volta Para Casa.",
    focus: "50% 25%",
  },
  {
    id: "user-andrew-electro-replacement",
    src: "media/user-andrew-electro-replacement.jpg",
    universe: "andrew",
    work: "O Espetacular Homem-Aranha 2",
    year: "2014",
    description: "Andrew Garfield caracterizado como Homem-Aranha nos bastidores.",
    source: "Arquivo fornecido pelo usuário",
    sourceUrl: "https://www.sonypictures.com/movies/theamazingspiderman2",
    credit: "Imagem fornecida pelo usuário",
    nature: "imagem de bastidores",
    usage: "Substituição visual indicada pelo usuário para o núcleo de Max Dillon.",
    alt: "Andrew Garfield sorrindo, caracterizado como Homem-Aranha, durante os bastidores.",
    focus: "50% 28%",
  },
  {
